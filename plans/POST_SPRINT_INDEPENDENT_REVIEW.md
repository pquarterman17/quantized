...
926,154 -> 915,000 B (11,154 B / 10.9 kB). `EAGER_JS_BUDGET` lowered to
916,024 (measured + 1,024 B) — a genuine ~1 kB headroom band, not the
prior ~0.3 kB. `scripts/check-bundle-size.mjs`'s header now states the
