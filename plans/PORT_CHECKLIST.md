...
- [~] Interactive render (uPlot 1D; Canvas2D for 2D maps) — uPlot 1D done (Stage: zoom/pan/cursor, overlays, ref lines, annotations, waterfall, per-series styling, grid/legend toggles). Canvas2D for 2D maps TODO.
