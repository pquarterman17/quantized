...
| BUG-009 | P2 | Pending-dataset contract | Five ad-hoc guards rather than one contract; row-state, worksheet editing/extract/copy and computed columns now resolve the complete book and resume automatically, while remaining consumers still refuse | ChatGPT-Sol | Refactor in progress: PRs #389–391 shipped; computed columns are PR #392; level order/recode and local analysis guards remain |
...
- [ ] **Replace "refuse" with "resolve-then-apply."** The guard refuses; it does not
  ...
  **Fourth implementation slice complete 2026-09-20 — PR #392, CI pending:**
