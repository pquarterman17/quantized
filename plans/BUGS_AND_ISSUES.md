...
| BUG-009 | P2 | Pending-dataset contract | Five ad-hoc guards rather than one contract; row-state, worksheet edits, Extract and Copy now resolve the complete book and resume automatically, while remaining consumers still refuse | ChatGPT-Sol | Refactor in progress: row state shipped in PR #389; worksheet edits shipped in #390; worksheet extract/copy are PR #391; computed columns, level order/recode and local analysis guards remain |
...
- [ ] **Replace "refuse" with "resolve-then-apply."** The guard refuses; it does not
  ...
  **Third implementation slice complete 2026-09-20 — PR #391, CI pending:**
  ...
  an old workspace has none. Remaining refusal families: computed columns,
  level order/recode, and local analysis guards.
