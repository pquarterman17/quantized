...
**Status:** Active
**Created:** 2026-07-03
**Updated:** 2026-07-09 (#38 lazy per-book transport CLOSED — see Completed;
#39 side-by-side comparison campaign still booked from the owner's PNR.opj
import testing; the four 2026-07-09 triage fix batches — perf quick wins,
zero-tail wrap-around prune, log tick steps, y2/legend/multi-panel fidelity —
land via feature branches and will be recorded in Completed on merge)
