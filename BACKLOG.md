...
**Last reconciled:** 2026-07-28 (twelfth pass). **The mission now
...
| JMP census-independent residuals + Tier 2 — J5 connect-means line; J9 flag-rows UI action (select → exclude/keep-only) + Dixon n>20 table re-verify; J3 bivariate confidence band (small `fit_stats` reuse); J7 By-role; J8 variability chart + variance components; J12 distribution depth. SHIPPED 2026-07-28/29: J3 both halves, J5 items 1–3, J6, J9 backend, J11, J17 (J10 multivariate in flight). J1/J2 ride the P1.4 contract; J4 = P1.5 (both Gate-A-sequenced) | JMP_GAP plan |
...
| `plans/JMP_GAP_PLAN.md` | Active | Gap register J1–J17 booked 2026-07-28; first campaign SHIPPED 2026-07-28/29 (J3 both halves, J5 items 1–3, J6, J9 backend, J11, J17; J10 in flight). Open: J1 string categoricals (with P1.4), J2 recode, J4 live group split (= P1.5), J5 connect-means, J7 By role, J8 variability + varcomp, J9 UI action, J12 distribution depth; Tier 3 census-gated = J13 clustering, J14 control charts/capability, J15 MSA, J16 DOE. Owner gate: Gate J census + switch trial |
