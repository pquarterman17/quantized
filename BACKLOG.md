...
| `plans/GUI_INTERACTION_PLAN.md` | Active | Tier 1 #1–#3,#5 + Tier 2 #8,#12,#15 + Tier 3 #16–#17 open; #11 core SHIPPED 2026-07-17 (residual open: Open in Figure Builder / stat-mark faceting / layer reordering); #4 SHIPPED 2026-07-12, #6 SHIPPED 2026-07-16, #7+#9+#10+#13+#14 SHIPPED 2026-07-17 (#10 docking deferred, #13 undo sub-item deferred to the #1 gate); 4 owner gates (undo scopes, baseline framing, tree scope, selection contract) |
