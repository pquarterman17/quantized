...
| **Graph Builder residuals** (core — save/duplicate/rename/delete, `.dwk` persistence, active-spec+dirty indicator, export — SHIPPED 2026-07-17; ordinary XY → Figure Builder READY in PR #62; explicit XY series order READY in stacked PR #63) — finish faceting for statistical marks; arbitrary multi-panel layer ordering belongs to #12 / ORIGIN #54 | GUI_INTERACTION #11 |
