...
| JMP Tier 1, census-independent slices — J3 Fit Y by X (incl. new chi-square/Fisher backend), J5 jitter/points-over-box/mean-CI/connect-means marks, J6 Tabulate v2 (nested groups, multi-stat, label-true TSV). J1/J2 ride the P1.4 contract; J4 = P1.5 (both Gate-A-sequenced) | JMP_GAP J1–J6 |
...
| `plans/JMP_GAP_PLAN.md` | Active | Gap register J1–J17 booked 2026-07-28. Tier 1 = J1 string categoricals (with P1.4) / J2 recode / J3 Fit Y by X / J4 live group split (= P1.5) / J5 marks / J6 Tabulate v2; Tier 2 = J7 By role, J8 variability chart + variance components, J9 outlier screening, J10 multivariate UI, J11 formula v2, J12 distribution depth, J17 JSL mapping doc; Tier 3 census-gated = J13 clustering, J14 control charts/capability, J15 MSA, J16 DOE. Owner gate: Gate J census + switch trial |
