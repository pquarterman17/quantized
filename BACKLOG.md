...
| `plans/GUI_INTERACTION_PLAN.md` | Active | Tier 1 #1–#3,#5 + Tier 2 #7–#9,#11–#15 + Tier 3 #16–#17 open; #4 SHIPPED 2026-07-12, #6 SHIPPED 2026-07-16, #10 SHIPPED 2026-07-17 (docking deferred); 4 owner gates (undo scopes, baseline framing, tree scope, selection contract) |
