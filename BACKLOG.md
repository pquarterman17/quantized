...
3. **The release-tracking docs were reconciled without ticking owner
   ...
   candidate was `v0.23.2-rc1` = `cd68ad16` (main after `#259`, 2026-08-29) — **superseded 2026-08-29 without ever being tagged**: `#260`-`#264` landed after it, so the candidate is `v0.23.2-rc2`, cut from `main` after `#264`. `RELEASE_BLOCKERS.md` checked: nothing rises to BLOCKER, its
