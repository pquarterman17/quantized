...
| **Graph Builder residuals** (core — save/duplicate/rename/delete, `.dwk` persistence, active-spec+dirty indicator, export — SHIPPED 2026-07-17; ordinary XY → Figure Builder READY in PR #62) — finish faceting for statistical marks; allow plot/layer reordering | GUI_INTERACTION #11 |
