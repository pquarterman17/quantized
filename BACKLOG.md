...
| Item | Plan / item |
|------|-------------|
| **Graph Builder residual** (core SHIPPED 2026-07-17; XY → Figure Builder + explicit XY series order SHIPPED 2026-07-18, Codex PRs #62/#63 merged `20be0e4`) — finish faceting for statistical marks; arbitrary multi-panel layer ordering belongs to #12 / ORIGIN #54 | GUI_INTERACTION #11 |
| **Real-browser (Playwright) interaction journeys** at 100/125/200% (core harness + 7 journeys — import-drop/folder-organize/curve-restyle/axis-limits/graph-builder/region-tool-escape/keyboard-only — SHIPPED 2026-07-17; export round-trip SHIPPED 2026-07-18, `frontend/e2e/`, 20/20 green) — residual: folder-reorder undo (gated on #1), channel→X/Y/Y2 on-canvas drag, annotation/shape move/edit/delete/undo, window arrange/restore | GUI_INTERACTION #15 |
