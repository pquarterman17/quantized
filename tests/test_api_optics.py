...
def test_fresnel_extreme_finite_input_is_422_not_500(client: TestClient) -> None:
...
def test_refractive_to_dielectric_extreme_finite_input_is_422_not_500(
    client: TestClient,
) -> None:
...
def test_dielectric_to_refractive_extreme_finite_input_is_422_not_500(
    client: TestClient,
) -> None:
