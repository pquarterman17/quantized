...
export function buildAnalysisCommands(s: StoreGet): Action[] {
  return [
    ...
    { id: "reductions-pawley", group: "Analyze", section: "XRD & reflectivity", label: "Pawley refinement…", description: "Refine a powder XRD unit cell against the whole pattern while fitting peak intensities freely.", keywords: "pawley whole pattern unit cell lattice powder xrd refinement", run: () => s().openReductions("pawley") },
