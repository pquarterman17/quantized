...
/** Group/facet bindings on the canonical draft. Gated on `canonical` only,
 *  and renders even when both are unset: either choice can be resolved from
 *  the bound dataset without reaching back into the live Stage. */
